...
const FAQSection = React.memo(() => {
  const faqs = [
    ...
    { question: "What is the AI Lead Conversion System?", answer: "The AI Lead Conversion System is HBOSB’s primary managed system for service businesses that need a more reliable way to respond to inquiries, follow up consistently, recover missed opportunities, and keep leads visible through the process. The exact configuration is confirmed during scope review." },
    { question: "Does this replace my staff?", answer: "No. HBOSB uses automation and AI to support repeatable parts of the process, such as intake, follow-up, routing, notifications, and tracking. Your team remains responsible for conversations, sales decisions, customer service, fulfillment, and situations that require human judgment." },
